...
public:
    ...
    void setupUi(QWidget *OrderInfo)
    {
        ...
        orderId->setGeometry(QRect(130, 40, 113, 28));
        label = new QLabel(OrderInfo);
        label->setObjectName("label");
        label->setGeometry(QRect(60, 40, 63, 21));
        label_2 = new QLabel(OrderInfo);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(60, 80, 63, 21));
        status = new QLineEdit(OrderInfo);
        status->setObjectName("status");
        status->setGeometry(QRect(130, 80, 113, 28));
        label_4 = new QLabel(OrderInfo);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(60, 120, 63, 21));
        address = new QLineEdit(OrderInfo);
        address->setObjectName("address");
        address->setGeometry(QRect(130, 120, 113, 28));
        cartList = new QTableWidget(OrderInfo);
        cartList->setObjectName("cartList");
        cartList->setGeometry(QRect(60, 160, 891, 351));
